...
<div class="container">
        ...
        <p>Este es un breve manual para ayudar a los usuarios a entender cómo utilizar tu sitio:</p>
        ...
        <h2>Registro y Inicio de Sesión</h2>
        <p>Para acceder a todas las funciones, debes registrarte y crear una cuenta. Una vez registrado, puedes iniciar sesión con tu nombre de usuario y contraseña.</p>
